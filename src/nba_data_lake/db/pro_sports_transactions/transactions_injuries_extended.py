        ...
        self._sql = self._SQL(
            ...
            table="""
                CREATE TABLE IF NOT EXISTS "{}" (
                    ...
                    "nba_team_id" INTEGER,
                    "nba_season_id"	TEXT NO CASE,
                    "nba_season" TEXT NO CASE,
                    "nba_season_type" TEXT NO CASE,
                    "nba_team_name"	TEXT NO CASE,
                    "nba_season_start" TEXT NO CASE,
                    "nba_season_end" TEXT NO CASE,
                    "nba_player_start" TEXT NO CASE,
                    "nba_player_end" TEXT NO CASE,
